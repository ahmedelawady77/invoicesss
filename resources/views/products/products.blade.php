					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class="card-body">
								...
								<!-- السيكشن دا اسم الفانكشن الي في الموديل لما بكتبها انا كدا واقف جوا تيبل السكشن و بختار بقي -->
												<td>{{$prod->section->section_name}}</td> 
												<td>{{$prod->description}}</td>
												<td>
                                    <!--  الداتا بروو دي علشان اخد اي دي الفيلد دا من تيبل البروداكت معايا في فورم التعديل -->
                                            ...
                                            <button class="btn btn-outline-danger btn-sm " data-pro_id="{{ $prod->id }}"
